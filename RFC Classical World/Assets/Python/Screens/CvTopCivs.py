...
#		iXHeaderPanelRemainingAfterLeader = self.X_LEADER_ICON + self.W_LEADER_ICON + self.iMarginSpace
	...
	def showScreen(self):
		...
		self.HistorianList = [	localText.getText("TXT_KEY_TOPCIVS_HISTORIAN1", ()),
					...
					localText.getText("TXT_KEY_TOPCIVS_HISTORIAN12", ()), # edead
					localText.getText("TXT_KEY_TOPCIVS_HISTORIAN13", ()), # edead
					localText.getText("TXT_KEY_TOPCIVS_HISTORIAN14", ()), # edead
					localText.getText("TXT_KEY_TOPCIVS_HISTORIAN15", ()), # edead
					localText.getText("TXT_KEY_TOPCIVS_HISTORIAN16", ()), # edead
					localText.getText("TXT_KEY_TOPCIVS_HISTORIAN17", ()), # edead
					localText.getText("TXT_KEY_TOPCIVS_HISTORIAN18", ()), # edead
					localText.getText("TXT_KEY_TOPCIVS_HISTORIAN19", ()), # edead
				    ]
	...
	def makeList(self, szType):
		...
		#for iPlayerLoop in range(gc.getMAX_PLAYERS()-1): #Rhye
                for iPlayerLoop in range(con.iNumPlayers): #Rhye
			...
			if (gc.getPlayer(iPlayerLoop).isAlive()):
				...
				# edead: start most pious civs
				if (szType == localText.getText("TXT_KEY_TOPCIVS_PIETY", ())):
					self.aiTopCivsValues.append([sd.getPiety(iPlayerLoop), iPlayerLoop])
				# edead: end
