...
/************************************************************************************************/
	...
	// edead: start	
	DllExport int getMapFoundValue(PlayerTypes ePlayer) const; // exposed to Python
	DllExport int getRegionID() const; // exposed to Python
	DllExport CvWString getRegionName(bool bTooltip = false) const; // exposed to Python
	DllExport void CvPlot::cameraLookAt(); // exposed to Python
	// edead: end
