...
void CvEventReporter::combatResult(CvUnit* pWinner, CvUnit* pLoser, CvUnit* pAttacker) // srpt slavery
{
	m_kPythonEventMgr.reportCombatResult(pWinner, pLoser, pAttacker); // srpt slavery
}

void CvEventReporter::improvementBuilt(int iImprovementType, int iX, int iY) // srpt
{
