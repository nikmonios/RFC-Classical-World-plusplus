...
void CyInfoPythonInterface1()
{
	...
	python::class_<CvUnitInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvUnitInfo")
		...
		.def("getOrStateReligion", &CvUnitInfo::getOrStateReligion, "int ()") // edead
		.def("getPrereqReligion", &CvUnitInfo::getPrereqReligion, "int ()")
		.def("getOrPrereqReligion", &CvUnitInfo::getOrPrereqReligion, "int ()") // edead
...
/************************************************************************************************/
		...
		.def("getArtDefineTag", &CvUnitInfo::getArtDefineTag, "string (int i, int eStyle)") // edead
		.def("isPurgeReligion", &CvUnitInfo::isPurgeReligion, "bool ()") // edead
		;
	...
	python::class_<CvBuildingInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvBuildingInfo")
		...
		.def("getOrStateReligion", &CvBuildingInfo::getOrStateReligion, "int ()") // edead
		.def("getPrereqReligion", &CvBuildingInfo::getPrereqReligion, "int ()")
		.def("getOrPrereqReligion", &CvBuildingInfo::getOrPrereqReligion, "int ()") // edead
