...
void CvDllPythonEvents::reportCombatResult(CvUnit* pWinner, CvUnit* pLoser, CvUnit* pAttacker)
{
	if (preEvent())
	{
		CyArgsList eventData;
...
void CvDllPythonEvents::reportImprovementBuilt(int iImprovementType, int iX, int iY)  // srpt
{
	if (preEvent())
	{
		CyArgsList eventData;
