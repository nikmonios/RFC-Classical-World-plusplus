...
void CyInfoPythonInterface3()
{
	...
	python::class_<CvLeaderHeadInfo, python::bases<CvInfoBase> >("CvLeaderHeadInfo")
		...
		.def("setFavoriteReligion", &CvLeaderHeadInfo::setFavoriteReligion, "void (int i)") // edead
		...
		.def("getFavoriteWonder", &CvLeaderHeadInfo::getFavoriteWonder, "int ()") // edead
	...
	python::class_<CvTraitInfo, python::bases<CvInfoBase> >("CvTraitInfo")
		...
		.def("getDiplomacyModifier", &CvTraitInfo::getDiplomacyModifier, "int ()") // edead - bonus to diplomacy
