...
public:
	...
	bool isAlwaysFullXP() const; // edead
	bool isMinorCiv() const; // edead
	...
	void setArtDefineTag(std::string szNewValue); // srpt indy unit art
...
protected:
	...
	// edead: start
	CvString m_szArtDefineTag; // srpt indy unit art
	// edead: end
