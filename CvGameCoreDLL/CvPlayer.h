...
/************************************************************************************************/
	...
	// iCivicHappiness in CIV4CivicInfos.xml
	int getCivicHappiness() const;
	void changeCivicHappiness(int iChange);
	
	// iDiplomacyModifier in CIV4TraitInfos.xml
	int getDiplomacyModifier() const;																																		// Exposed to Python 
	void changeDiplomacyModifier(int iChange);
	int getLuck() const;
	void setLuck(int iNewValue);
	int getBorders(int iPlayer) const;
	// edead - end
	...
	EventTriggeredData* initTriggeredData(EventTriggerTypes eEventTrigger, bool bFire = false, int iCityId = -1, int iPlotX = INVALID_PLOT_COORD, int iPlotY = INVALID_PLOT_COORD, PlayerTypes eOtherPlayer = NO_PLAYER, int iOtherPlayerCityId = -1, ReligionTypes eReligion = NO_RELIGION, CorporationTypes eCorporation = NO_CORPORATION, int iUnitId = -1, BuildingTypes eBuilding = NO_BUILDING, CvWString szCustomText = L""); // edead
    ...
    bool isHasBuilding(BuildingTypes eIndex); // srpt
