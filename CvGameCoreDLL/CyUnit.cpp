...
// edead: start
bool CyUnit::isAlwaysFullXP()
{
	return m_pUnit ? (int) m_pUnit->isAlwaysFullXP() : false;
}
void CyUnit::setArtDefineTag(std::string szNewValue)
{
	if (m_pUnit)
	{
		m_pUnit->setArtDefineTag(szNewValue);
	}
} // srpt indy unit art
// edead: end