...
void CyPlayerPythonInterface2(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("getBorders", &CyPlayer::getBorders, "int (int i)") //edead
		...
		.def("AI_getUnitAIModifier", &CyPlayer::AI_getUnitAIModifier, "int (int)") // edead
		.def("AI_setUnitAIModifier", &CyPlayer::AI_setUnitAIModifier, "void (int, int)") // edead
