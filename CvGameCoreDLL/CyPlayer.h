...
public:
	...
	bool isHuman();
	bool isBarbarian();
	void setName(std::wstring szNewValue); // edead
	void setCivName(std::wstring szNewDesc, std::wstring szNewShort, std::wstring szNewAdj); // edead
	std::wstring getName();
	...
	// edead: start
	int getDiplomacyModifier() const;
	void changeDiplomacyModifier(int iChange);
	int getLuck() const;
	void setLuck(int iNewValue);
	int AI_getUnitAIModifier(int /*UnitAITypes*/ eUnitAI) const;
	void AI_setUnitAIModifier(int /*UnitAITypes*/ eUnitAI, int iNewValue);
	// edead: end
	
	int getSettlersMaps(int y, int x); //Rhye
	int getBorders(int i); //edead
