...
/************************************************************************************************/
	...
	bool isHasEverMet(TeamTypes eIndex) const; // edead
	...
	int getBestKnownTechScorePercent() const; // BETTER_BTS_AI_MOD / General AI																										// Exposed to Python
