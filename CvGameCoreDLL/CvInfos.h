...
public:
	...
	// edead: start
	bool isPurgeReligion() const;
	bool isAlwaysFullXP() const;
	int getAutoPillageProb() const;
	// edead: end
	...
	const TCHAR* getArtDefineTag(int i, int eStyle) const; // edead
...
protected:
	...
	// edead: start
	bool m_bPurgeReligion;
	bool m_bAlwaysFullXP;
	int m_iAutoPillageProb;
	// edead: end
...
public:
	...
	DllExport const int getStartingYear() const;				// Exposed to Python
	int pyGetStartingYear() { return getStartingYear(); }				// Exposed to Python
...
public:
	...
	void setFavoriteReligion(int i); // edead
	...
	// edead: start
	int getFavoriteWonder() const;																// Exposed to Python
	// edead: end
...
protected:
	...
	int m_iMercenaryHireOdds;
	int m_iCompactEmpireModifier;
	// edead: end
...
public:
	...
	int getDiplomacyModifier() const; // edead - bonus to Diplomacy
...
protected:
	...
	int m_iDiplomacyModifier; // edead - bonus to Diplomacy
