...
public:
	...
	int getCivicHappiness() const; // edead
...
/*************************************************************************************************/
	...
	// srpt start Happiness from Specialists
	...
	int calculateTradeProfitTimes100(CvCity* pCity) const; // edead
...
/************************************************************************************************/
	...
	int* m_aiBonusCommerceRateModifier; //BCM: Added 26.9.09
	int* m_aiTradeYield;
