...
void CvDllTranslator::initializeTags(CvWString& szTagStartIcon, CvWString& szTagStartOur, CvWString& szTagStartCT, CvWString& szTagStartColor, CvWString& szTagStartLink, CvWString& szTagEndLink, CvWString& szEndLinkReplacement, std::map<std::wstring, CvWString>& aIconMap, std::map<std::wstring, CvWString>& aColorMap)
{
	...
	aIconMap[L"[ICON_CONFUCIANISM]"] = std::wstring(1, (wchar)GC.getReligionInfo((ReligionTypes)CONFUCIANISM).getChar());
	aIconMap[L"[ICON_TAOISM]"] = std::wstring(1, (wchar)GC.getReligionInfo((ReligionTypes)TAOISM).getChar());
	aIconMap[L"[ICON_HINDUISM]"] = std::wstring(1, (wchar)GC.getReligionInfo((ReligionTypes)HINDUISM).getChar());
	aIconMap[L"[ICON_ISLAM]"] = std::wstring(1, (wchar)GC.getReligionInfo((ReligionTypes)ISLAM).getChar());
	aIconMap[L"[ICON_MANICHAEISM]"] = std::wstring(1, (wchar)GC.getReligionInfo((ReligionTypes)MANICHAEISM).getChar());
	aIconMap[L"[ICON_BUDDHISM]"] = std::wstring(1, (wchar)GC.getReligionInfo((ReligionTypes)BUDDHISM).getChar());
	aIconMap[L"[ICON_ZOROASTRIANISM]"] = std::wstring(1, (wchar)GC.getReligionInfo((ReligionTypes)ZOROASTRIANISM).getChar());
	aIconMap[L"[ICON_CHRISTIANITY]"] = std::wstring(1, (wchar)GC.getReligionInfo((ReligionTypes)CHRISTIANITY).getChar());
	aIconMap[L"[ICON_JAINISM]"] = std::wstring(1, (wchar)GC.getReligionInfo((ReligionTypes)JAINISM).getChar());
	aIconMap[L"[ICON_HELLENISM]"] = std::wstring(1, (wchar)GC.getReligionInfo((ReligionTypes)HELLENISM).getChar());
	aIconMap[L"[ICON_GRAINMERCHANTS]"] = std::wstring(1, (wchar)GC.getCorporationInfo((CorporationTypes)GRAINMERCHANTS).getChar());
	aIconMap[L"[ICON_FISHMERCHANTS]"] = std::wstring(1, (wchar)GC.getCorporationInfo((CorporationTypes)FISHMERCHANTS).getChar());
	aIconMap[L"[ICON_CLOTHMERCHANTS]"] = std::wstring(1, (wchar)GC.getCorporationInfo((CorporationTypes)CLOTHMERCHANTS).getChar());
	aIconMap[L"[ICON_SPICEMERCHANTS]"] = std::wstring(1, (wchar)GC.getCorporationInfo((CorporationTypes)SPICEMERCHANTS).getChar());
	aIconMap[L"[ICON_ARTISANS]"] = std::wstring(1, (wchar)GC.getCorporationInfo((CorporationTypes)ARTISANS).getChar());
	aIconMap[L"[ICON_TRADESMEN]"] = std::wstring(1, (wchar)GC.getCorporationInfo((CorporationTypes)TRADESMEN).getChar());
	// edead: end
