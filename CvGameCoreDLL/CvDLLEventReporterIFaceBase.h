...
public:
	...
	//virtual void combatResult(CvUnit* pWinner, CvUnit* pLoser) = 0;					// srpt comment
	virtual void combatResult(CvUnit* pWinner, CvUnit* pLoser, CvUnit* pAttacker) = 0;					// srpt slavery
