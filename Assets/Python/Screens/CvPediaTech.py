	...
	def placeUnits(self):
		...
		for eLoopUnit in range(gc.getNumUnitInfos()):
			if (eLoopUnit != -1):
				...
				if (isTechRequiredForUnit(self.iTech, eLoopUnit) and not gc.getUnitInfo(eLoopUnit).isGraphicalOnly()): # edead
